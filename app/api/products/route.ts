  ...
  try {
    ...
    const row = await prisma.product.create({
      data: {
        ...
        stockS: body.stockS != null ? Number(body.stockS) : 10,
        stockM: body.stockM != null ? Number(body.stockM) : 10,
        stockL: body.stockL != null ? Number(body.stockL) : 10,
        stockXL: body.stockXL != null ? Number(body.stockXL) : 10,
